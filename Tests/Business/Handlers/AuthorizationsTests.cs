...
namespace Tests.Business.Handlers
{
    ...
    public class AuthorizationsTests
    {
        ...
        public async Task Handler_Login()
        {
            ...
            _tokenHelper.Setup(x => x.CreateToken<DArchToken>(new UserJwtDto
            {
        ...
        public async Task Handler_LoginWithRefreshTokenCommand_Success()
        {
            ...
            _tokenHelper.Setup(x => x.CreateToken<AccessToken>(new UserJwtDto
            {
                AuthenticationProviderType = It.IsAny<User>().AuthenticationProviderType,
                UserId = It.IsAny<User>().UserId,
                FullName = It.IsAny<User>().FullName,
            ...
            _tokenHelper.Verify(x => x.CreateToken<AccessToken>(new UserJwtDto
            {
                AuthenticationProviderType = It.IsAny<User>().AuthenticationProviderType,
                UserId = It.IsAny<User>().UserId,
                FullName = It.IsAny<User>().FullName,
