...
namespace Business.Helpers
{
    public static class FakeDataMiddlleware
    {
        public static async Task UseDbFakeDataCreator(this IApplicationBuilder app)
        {
            ...
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "ArtistPortalLoginTitle", Value = "Sanatçı Girişi" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "ArtistPortalLoginTitle", Value = "Artist Login" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "SubscriptionPageTitle", Value = "Abonelik Yönetimi" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "SubscriptionPageTitle", Value = "Subscripton Management" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelPageInvoiceTitle", Value = "Faturalar" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelPageInvoiceTitle", Value = "Invoices" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelPageContractTitle", Value = "Sözleşmeler" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelPageContractTitle", Value = "Contracts" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelPageOrderTitle", Value = "Siparişler" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelPageOrderTitle", Value = "Orders" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelPageCompaniesDocTitle", Value = "Şirket Dökümanları" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelPageCompaniesDocTitle", Value = "Companies Docs" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelOurServicesTitle", Value = "Hizmetlerimiz" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelOurServicesTitle", Value = "Our Services" });

            await mediator.Send(new CreateTranslateInternalCommand { LangId = 1, Code = "AdminPanelCuponCodesTitle", Value = "Kupon Kodlarımız" });
            await mediator.Send(new CreateTranslateInternalCommand { LangId = 2, Code = "AdminPanelCuponCodesTitle", Value = "Cupon Codes" });
